...
begin
    ...
    begin    
        ...
        begin
            showmessage('DataSet  je ispravna komponenta, ali još: ne postoji DataSource, pomakni čitanje SQL-a na kasniji korak u programu.');
        end;
...
// dataset može biti naziv dataseta, ali i grida, bilo čega što je ovdje implementirano if else if...'
function oxGetDataset(dataset: String): TdlDataSet;
var c: TComponent;
begin
    c := AresFindComponent(dataset, OwnerForm);
...
begin
    ...
    begin    
        _macro.eventlogadd('Element '  + ofElement + ' je pronađen, testiram vrstu'); // ovdje naredati sve moguće class opcije za koje želimo impelentirati traženje vrijednosti
